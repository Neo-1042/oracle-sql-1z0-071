...
-- e.g. 'Rodrigo R. Hurtado' will not pass. Rather, it must be 'Rodrigo Rafael Hurtado'
...
-- When you add a PK to a table, the table is automatically and PHYSICALLY sorted by this field
...
(
	...
	,CONSTRAINT PK_tbl_employee3 PRIMARY KEY (employee_number) -- in-line specification
);
...
-- Make the PK column INVISIBLE
-- (Interesting, SELECT * alone does not rule out the existence of a column)
